...
import{WidgetService} from '../widgets-dropdown/widget.service'
@Component({
...
countjoueur:any ;
  constructor(
    private changeDetectorRef: ChangeDetectorRef,private service : WidgetService
  ) {}
  ...
  ngOnInit(): void {
    ...
    this.service.countdoc().subscribe((res)=>{
      this.countdoc=res ;
    })
    this.service.countjoueur().subscribe((res)=>{
      this.countjoueur=res;
    })
    this.service.countmembre().subscribe((res)=>{
      this.countmembre=res ;
    })
    this.setData();
  }
